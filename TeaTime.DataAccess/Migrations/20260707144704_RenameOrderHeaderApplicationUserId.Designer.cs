...
namespace TeaTime.DataAccess.Migrations
{
    ...
    [Migration("20260707144704_RenameOrderHeaderApplicationUserId")]
    partial class RenameOrderHeaderApplicationUserId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TeaTime.Models.OrderDetailModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TeaTime.Models.OrderHeaderModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TeaTime.Models.ShoppingCartModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TeaTime.Models.StoreModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TeaTime.Models.OrderDetailModel", b =>
                {
                    b.HasOne("TeaTime.Models.OrderHeaderModel", "OrderHeader")
                        .WithMany()
                        .HasForeignKey("OrderHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TeaTime.Models.ProductModel", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("TeaTime.Models.ProductModel", b =>
                {
                    b.HasOne("TeaTime.Models.CategoryModel", "Category")
                        .WithMany()
